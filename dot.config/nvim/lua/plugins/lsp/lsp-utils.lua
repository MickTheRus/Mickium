...
M.on_attach = function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>gd", "<cmd>Telescope lsp_definitions<cr>", { desc = "Definations" }, bufopts)
	vim.keymap.set("n", "<leader>gr", "<cmd>Telescope lsp_references<cr>", { desc = "References" }, bufopts)
	...
	vim.keymap.set("n", "<leader>rn", vim.lsp.buf.rename, { desc = "Replace all word" }, bufopts)
