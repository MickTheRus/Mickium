...
local DEFAULT_CONFIG = {
	...
	colors = require("MickTheme.palette"),
	overrides = {},
}
...
local function apply(configs)
	...
	local groups = require("MickTheme.groups").setup(configs)
...
---load MickTheme colorscheme
local function load()
	if vim.version().minor < 7 then
		vim.notify_once("MickTheme: you must use neovim 0.7 or higher")
		return
	end
