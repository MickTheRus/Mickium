...
--end
--
--awful.widget.watch('get-cpu.sh', 2, function(self, stdout)
  ...
  s.mywibox:setup {
    {
      ...
      { -- Right widgets
        ...
        --container_cpu_widget,
        --container_mem_widget,
        -- containmicker_brightness_widget,
        container_vol_widget,
        -- container_battery_widget,
        container_clock_widget,
        layoutbox,
...
--		{ description = "show help", group = "awesome" }),
  ...
  awful.key({ modkey, "Shift" }, "s",
    function() awful.spawn("scrot -s -q 100" .. os.getenv("HOME") .. "/Pictures/screenshots/%Y-%m-%d_$wx$h.png") end,
  ...
  awful.key({}, "XF86MonBrightnessDown",
    function()
      awful.spawn("brightness-down.sh")
      br_signal:emit_signal("timeout")
      --awful.spawn.easy_async(brightness, function(stdout)
      --	naughty.notify {
      --		--title = "Brightness",
